...
const craftFacts=[
  ...
  {title:'Open up\nto better.',body:'A precise fit. A clear view of what’s inside. Scroll to see how the lid and container come together.',tag:'02 / A closer look inside'},
...
export default function HomeExperience() {
  ...
  const [finish,setFinish]=useState(0);const [retry,setRetry]=useState(0);const [chapter,setChapter]=useState('main-content');const dragging=useRef<number|null>(null);const reduced=useReducedMotion();
